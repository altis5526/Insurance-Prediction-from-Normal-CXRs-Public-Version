...
if __name__ == "__main__":
    ...
    if args.mode == "train":
        train_dataset = MIMIC_raw_permuted_label(train_path, resize=args.resize, transform=True)
        val_dataset = MIMIC_raw_permuted_label(val_path, resize=args.resize, transform=False)
    elif args.mode == "test":
        train_dataset = MIMIC_raw_permuted_label(train_path, resize=args.resize, transform=True)
        val_dataset = MIMIC_raw_permuted_label(val_path, resize=args.resize, transform=False)
