...
#SBATCH --job-name=mg_e4h_bs_sfix
...
mkdir -p "$LOG_DIR"
LOG_FILE="${LOG_DIR}/exp4_high_${SLURM_JOB_ID}.log"
...
### Logging header
echo "========================================="
echo "Bootstrap Evaluation - Exp4 HighPass mamba_s_fix [MedGemma]"
...
if [ $PYTHON_EXIT -eq 0 ]; then
    echo "========================================="
    echo "COMPLETED: exp4 highpass mamba_s_fix at $(date)"
    echo "========================================="
else
