...
mkdir -p "$LOG_DIR"
LOG_FILE="${LOG_DIR}/exp3_${SLURM_JOB_ID}.log"
...
### Logging header
echo "========================================="
echo "Bootstrap Evaluation - Exp3 mamba_s_fix [MedGemma]"
...
### Run bootstrap evaluation (loops over demo combos internally)
python -u run_exp3_bootstrap_medgemma_s_fix.py \
    --test_path "$TEST_PATH" \
    --n_bootstrap 20 \
    --sample_size 1000 \
    --seed 42 \
...
if [ $PYTHON_EXIT -eq 0 ]; then
    echo "========================================="
    echo "COMPLETED: exp3 mamba_s_fix at $(date)"
    echo "========================================="
else
