...
#SBATCH --job-name=mg_exp2_mamba_t
...
### Logging
EXPERIMENT_NAME="mg_exp2_mamba_t"
...
### Run Experiment 2 - MedMamba-T (Tiny, 8 resolutions)
python run_exp2.py \
...
mkdir -p $HF_WEIGHTS/exp2_medgemma_t
for res in 2 4 7 14 28 56 112 224; do
    SRC=$ROOT/${res}_mg_exp2/mamba_t/Rand123/Rand123_${res}_mg_mamba_t_resize_model_aucbest.pt
    DST=$HF_WEIGHTS/exp2_medgemma_t/mamba_t_${res}.pt
