...
from swintransformer import SwinTDoubleLinear_CheXpert
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_index", help='', type=str, default=None)
    parser.add_argument("--val_index", help='', type=str, default=None)

    args = parser.parse_args()

    set_seed(args.seed)
    torch.cuda.set_device(1)
    weight_dir = os.path.join(args.weight_dir, f'Rand{str(args.seed)}')
    ...
    encoder = SwinTDoubleLinear_CheXpert(use_checkpoint=True, num_classes=num_classes)
    encoder.to(device)
