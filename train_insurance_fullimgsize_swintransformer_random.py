...
from RawImageDataset import MIMIC_raw, MIMIC_raw_permuted_label
...
if __name__ == "__main__":
    ...
    if args.mode == "train":
        train_dataset = MIMIC_raw_permuted_label(train_path, transform=True)
        val_dataset = MIMIC_raw_permuted_label(val_path, transform=False)
    elif args.mode == "test":
        train_dataset = MIMIC_raw_permuted_label(train_path, transform=True)
        val_dataset = MIMIC_raw_permuted_label(val_path, transform=False)
